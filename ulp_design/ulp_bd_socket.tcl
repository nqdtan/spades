...
if { $list_projs eq "" } {
   create_project -force project_1 myproj_socket_${num_sockets} -part xcvc1902-vsvd1760-2MP-e-S
...
xilinx.com:RTLKernel:socket_manager:1.0\
...
proc create_root_design { parentCell num_sockets } {

  set num_noc_si  [expr {$num_sockets * 2 + 1}]
  set num_noc_mi  [expr {$num_sockets}]
  set num_noc_clk [expr {$num_sockets * 2 + 1}]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {BLP_S_INI_PLRAM_00} \
 ...
 ] [get_bd_intf_pins /axi_noc_h2c/S02_INI]
  ...
  set_property -dict [list \
    CONFIG.NUM_NSI {0} \
    CONFIG.NUM_CLKS ${num_noc_clk} \
    CONFIG.NUM_MI ${num_noc_mi} \
    CONFIG.NUM_NMI {4} \
    CONFIG.NUM_SI ${num_noc_si} \
  ] $axi_noc_kernel0
  ...
  set_property -dict [ list \
   ...
   CONFIG.CATEGORY {pl} \
 ] [get_bd_intf_pins /axi_noc_kernel0/M00_AXI]
...
#  set_property -dict [ list \
#   CONFIG.CONNECTIONS {M00_INI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}}} \
...
#  append m_noc_config " M00_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_INI { read_bw {5} write_bw {5}} "
#  append m_noc_config1 " M01_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} "

  append m_noc_config " M00_INI { read_bw {5} write_bw {5}} "
  append m_noc_config1 " M00_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M03_INI { read_bw {5} write_bw {5}} "

  # for socket_manager
  set_property -dict [list CONFIG.CONNECTIONS ${m_noc_config} \
   CONFIG.DEST_IDS {M00_AXI:0x40} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl} \
  ] [get_bd_intf_pins /axi_noc_kernel0/S00_AXI]
  ...
  for {set c 0} {$c < $num_sockets} {incr c} {
    ...
    if {$c == 0} {
      append m_noc_config " M03_INI { read_bw {5} write_bw {5}} "
      set_property -dict [ list \
       CONFIG.DATA_WIDTH {512} \
       CONFIG.CONNECTIONS ${m_noc_config} \
       CONFIG.CATEGORY {pl} \
     ] [get_bd_intf_pins /axi_noc_kernel0/${p1}_AXI]
   } else {
      append m_noc_config1 " M00_INI { read_bw {5} write_bw {5}} "
      set_property -dict [ list \
       CONFIG.DATA_WIDTH {512} \
       CONFIG.CONNECTIONS ${m_noc_config1} \
       CONFIG.CATEGORY {pl} \
     ] [get_bd_intf_pins /axi_noc_kernel0/${p1}_AXI]
   }
    ...
    set_property -dict [ list \
     ...
     CONFIG.CATEGORY {pl} \
   ] [get_bd_intf_pins /axi_noc_kernel0/${p2}_AXI]
 }
  ...
  # Create instance: mbufgce_primitive_1, and set properties
  set mbufgce_primitive_1 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_1 ]

  # Create instance: mbufgce_primitive_2, and set properties
  set mbufgce_primitive_2 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_2 ]

  # Create instance: mbufgce_primitive_3, and set properties
  set mbufgce_primitive_3 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_3 ]

  # Create instance: mbufgce_primitive_4, and set properties
  set mbufgce_primitive_4 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_4 ]

  # Create instance: mbufgce_primitive_5, and set properties
  set mbufgce_primitive_5 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_5 ]

  # Create instance: mbufgce_primitive_6, and set properties
  set mbufgce_primitive_6 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_6 ]

  # Create instance: mbufgce_primitive_7, and set properties
  set mbufgce_primitive_7 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_7 ]

  # Create instance: mbufgce_primitive_8, and set properties
  set mbufgce_primitive_8 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_8 ]

  # Create instance: mbufgce_primitive_9, and set properties
  set mbufgce_primitive_9 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_9 ]

  # Create instance: mbufgce_primitive_10, and set properties
  set mbufgce_primitive_10 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_10 ]

  # Create instance: mbufgce_primitive_11, and set properties
  set mbufgce_primitive_11 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_11 ]

  # Create instance: mbufgce_primitive_src, and set properties
  set mbufgce_primitive_src [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:mbufgce_primitive:1.0 mbufgce_primitive_src ]

  # Create instance: reset_controllers
  create_hier_cell_reset_controllers [current_bd_instance .] reset_controllers

  # Create instance: socket_manager_0, and set properties
  set socket_manager_0 [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:socket_manager:1.0 socket_manager_0 ]

  # Create instance: socket_top_0, and set properties
  for {set c 0} {$c < $num_sockets} {incr c} {
    set socket_top_$c [ create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:socket_top:1.0 socket_top_$c ]
  }
  ...
  connect_bd_intf_net -intf_net axi_ic_user_M01_AXI [get_bd_intf_pins axi_ic_user/M01_AXI] [get_bd_intf_pins axi_register_slice_1/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_noc_h2c_M01_AXI [get_bd_intf_pins axi_noc_h2c/M01_AXI] [get_bd_intf_pins axi_register_slice_2/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_register_slice_0_M_AXI [get_bd_intf_pins axi_noc_kernel0/S00_AXI] [get_bd_intf_pins axi_register_slice_0/M_AXI]
  connect_bd_intf_net -intf_net axi_register_slice_1_M_AXI [get_bd_intf_pins axi_register_slice_1/M_AXI] [get_bd_intf_pins socket_manager_0/s_axi_control]
  connect_bd_intf_net -intf_net axi_register_slice_2_M_AXI [get_bd_intf_pins axi_register_slice_2/M_AXI] [get_bd_intf_pins socket_manager_0/s]
  connect_bd_intf_net -intf_net socket_manager_0_m0 [get_bd_intf_pins axi_register_slice_0/S_AXI] [get_bd_intf_pins socket_manager_0/m0]
  connect_bd_intf_net -intf_net axi_noc_kernel0_M03_INI [get_bd_intf_pins axi_noc_h2c/S02_INI] [get_bd_intf_pins axi_noc_kernel0/M03_INI]

  for {set c 0} {$c < $num_sockets} {incr c} {
    set c1 [expr {$c + 0}]
    if {$c1 < 10} { 
      connect_bd_intf_net -intf_net axi_noc_kernel0_M0${c1}_AXI [get_bd_intf_pins axi_noc_kernel0/M0${c1}_AXI] [get_bd_intf_pins socket_top_${c}/s0]
    } else {
      connect_bd_intf_net -intf_net axi_noc_kernel0_M${c1}_AXI [get_bd_intf_pins axi_noc_kernel0/M${c1}_AXI] [get_bd_intf_pins socket_top_${c}/s0]
    }
  }
  ...
  connect_bd_net -net blp_s_aclk_kernel_00_1 [get_bd_ports blp_s_aclk_kernel_00] [get_bd_pins axi_ic_user/aclk1] [get_bd_pins axi_noc_h2c/aclk1] [get_bd_pins axi_noc_kernel0/aclk0] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axi_register_slice_1/aclk] [get_bd_pins axi_register_slice_2/aclk] [get_bd_pins mbufgce_primitive_src/clk_in] [get_bd_pins reset_controllers/clk_kernel0] [get_bd_pins socket_manager_0/clk]
  connect_bd_net -net blp_s_aclk_kernel_01_1 [get_bd_ports blp_s_aclk_kernel_01] [get_bd_pins reset_controllers/clk_kernel1]
  connect_bd_net -net blp_s_aclk_pcie_00_1 [get_bd_ports blp_s_aclk_pcie_00] [get_bd_pins axi_dbg_fw/aclk] [get_bd_pins axi_dbg_hub/aclk] [get_bd_pins axi_noc_h2c/aclk0] [get_bd_pins ip_pipe_dbg_hub_fw_00/clk] [get_bd_pins reset_controllers/clk_pcie]
  ...
  connect_bd_net -net mbufgce_primitive_src_clk_out_o1 [get_bd_pins mbufgce_primitive_0/clk_in] [get_bd_pins mbufgce_primitive_1/clk_in] [get_bd_pins mbufgce_primitive_10/clk_in] [get_bd_pins mbufgce_primitive_11/clk_in] [get_bd_pins mbufgce_primitive_2/clk_in] [get_bd_pins mbufgce_primitive_3/clk_in] [get_bd_pins mbufgce_primitive_4/clk_in] [get_bd_pins mbufgce_primitive_5/clk_in] [get_bd_pins mbufgce_primitive_6/clk_in] [get_bd_pins mbufgce_primitive_7/clk_in] [get_bd_pins mbufgce_primitive_8/clk_in] [get_bd_pins mbufgce_primitive_9/clk_in] [get_bd_pins mbufgce_primitive_src/clk_out_o1]
  connect_bd_net -net reset_controllers_peripheral_aresetn [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins axi_register_slice_1/aresetn] [get_bd_pins axi_register_slice_2/aresetn] [get_bd_pins reset_controllers/peripheral_aresetn] [get_bd_pins socket_manager_0/resetn]
  connect_bd_net -net reset_controllers_resetn_pl_axi [get_bd_pins axi_gpio_null_user/s_axi_aresetn] [get_bd_pins axi_ic_user/aresetn] [get_bd_pins axi_ic_user_extend/aresetn] [get_bd_pins reset_controllers/resetn_pl_axi]
  connect_bd_net -net resetn_pcie_axi_net [get_bd_pins axi_dbg_hub/aresetn] [get_bd_pins reset_controllers/resetn_pcie_axi]
  connect_bd_net -net socket_manager_0_mbufgce0_clr_n [get_bd_pins mbufgce_primitive_0/clr_n] [get_bd_pins socket_manager_0/mbufgce0_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce10_clr_n [get_bd_pins mbufgce_primitive_10/clr_n] [get_bd_pins socket_manager_0/mbufgce10_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce11_clr_n [get_bd_pins mbufgce_primitive_11/clr_n] [get_bd_pins socket_manager_0/mbufgce11_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce1_clr_n [get_bd_pins mbufgce_primitive_1/clr_n] [get_bd_pins socket_manager_0/mbufgce1_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce2_clr_n [get_bd_pins mbufgce_primitive_2/clr_n] [get_bd_pins socket_manager_0/mbufgce2_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce3_clr_n [get_bd_pins mbufgce_primitive_3/clr_n] [get_bd_pins socket_manager_0/mbufgce3_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce4_clr_n [get_bd_pins mbufgce_primitive_4/clr_n] [get_bd_pins socket_manager_0/mbufgce4_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce5_clr_n [get_bd_pins mbufgce_primitive_5/clr_n] [get_bd_pins socket_manager_0/mbufgce5_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce6_clr_n [get_bd_pins mbufgce_primitive_6/clr_n] [get_bd_pins socket_manager_0/mbufgce6_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce7_clr_n [get_bd_pins mbufgce_primitive_7/clr_n] [get_bd_pins socket_manager_0/mbufgce7_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce8_clr_n [get_bd_pins mbufgce_primitive_8/clr_n] [get_bd_pins socket_manager_0/mbufgce8_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce9_clr_n [get_bd_pins mbufgce_primitive_9/clr_n] [get_bd_pins socket_manager_0/mbufgce9_clr_n]
  connect_bd_net -net socket_manager_0_mbufgce_ce [get_bd_pins mbufgce_primitive_0/ce] [get_bd_pins mbufgce_primitive_1/ce] [get_bd_pins mbufgce_primitive_10/ce] [get_bd_pins mbufgce_primitive_11/ce] [get_bd_pins mbufgce_primitive_2/ce] [get_bd_pins mbufgce_primitive_3/ce] [get_bd_pins mbufgce_primitive_4/ce] [get_bd_pins mbufgce_primitive_5/ce] [get_bd_pins mbufgce_primitive_6/ce] [get_bd_pins mbufgce_primitive_7/ce] [get_bd_pins mbufgce_primitive_8/ce] [get_bd_pins mbufgce_primitive_9/ce] [get_bd_pins socket_manager_0/mbufgce_ce]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins mbufgce_primitive_src/ce] [get_bd_pins mbufgce_primitive_src/clr_n] [get_bd_pins xlconstant_0/dout]

  for {set c 0} {$c < $num_sockets} {incr c} {
    set c1 [expr {$c * 2 + 1}]
    set c2 [expr {$c * 2 + 2}]
    if {$c1 < 10} {
      connect_bd_intf_net -intf_net socket_top_${c}_m0 [get_bd_intf_pins axi_noc_kernel0/S0${c1}_AXI] [get_bd_intf_pins socket_top_${c}/m0]
    } else {
      connect_bd_intf_net -intf_net socket_top_${c}_m0 [get_bd_intf_pins axi_noc_kernel0/S${c1}_AXI] [get_bd_intf_pins socket_top_${c}/m0]
    }
    if {$c2 < 10} {
      connect_bd_intf_net -intf_net socket_top_${c}_m1 [get_bd_intf_pins axi_noc_kernel0/S0${c2}_AXI] [get_bd_intf_pins socket_top_${c}/m1]
    } else {
      connect_bd_intf_net -intf_net socket_top_${c}_m1 [get_bd_intf_pins axi_noc_kernel0/S${c2}_AXI] [get_bd_intf_pins socket_top_${c}/m1]
    }
  }
  ...
  for {set c 0} {$c < $num_sockets} {incr c} {
    ...
    connect_bd_net -net mbufgce_primitive_${c}_clk_out_o1 [get_bd_pins axi_noc_kernel0/aclk${c1}] [get_bd_pins mbufgce_primitive_${c}/clk_out_o1] [get_bd_pins socket_top_${c}/f_clk]
    connect_bd_net -net mbufgce_primitive_${c}_clk_out_o2 [get_bd_pins axi_noc_kernel0/aclk${c2}] [get_bd_pins mbufgce_primitive_${c}/clk_out_o2] [get_bd_pins socket_top_${c}/clk]
  }

  # Create address segments
  assign_bd_address -offset 0x00C100000000 -range 0x000300000000 -target_address_space [get_bd_addr_spaces socket_manager_0/m0] [get_bd_addr_segs BLP_M_M00_INI_0/Reg] -force
  ...
  assign_bd_address -offset 0x020200001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces BLP_S_AXI_CTRL_USER_00] [get_bd_addr_segs socket_manager_0/s_axi_control/reg0] -force
  ...
  assign_bd_address -offset 0x020204000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces BLP_S_INI_PLRAM_00] [get_bd_addr_segs socket_manager_0/s/reg0] -force

  set socket_base_addr 0x020100000000
  for {set c 0} {$c < $num_sockets} {incr c} {
    assign_bd_address -offset ${socket_base_addr} -range 0x40000000 -target_address_space [get_bd_addr_spaces socket_manager_0/m0] [get_bd_addr_segs socket_top_${c}/s0/reg0] -force
    assign_bd_address -offset ${socket_base_addr} -range 0x40000000 -target_address_space [get_bd_addr_spaces socket_top_0/m0] [get_bd_addr_segs socket_top_${c}/s0/reg0] -force
    if {$c > 0} {
      assign_bd_address -offset 0x020100000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces socket_top_${c}/m0] [get_bd_addr_segs socket_top_0/s0/reg0] -force
    }
    assign_bd_address -offset 0x020204000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces socket_top_$c/m0] [get_bd_addr_segs socket_manager_0/s/reg0] -force

    assign_bd_address -offset 0x00C100000000 -range 0x000300000000 -target_address_space [get_bd_addr_spaces socket_top_${c}/m0] [get_bd_addr_segs BLP_M_M00_INI_0/Reg] -force
    assign_bd_address -offset 0x00C100000000 -range 0x000300000000 -target_address_space [get_bd_addr_spaces socket_top_${c}/m1] [get_bd_addr_segs BLP_M_M01_INI_0/Reg] -force
    set socket_base_addr [expr {$socket_base_addr + 0x40000000}]
    if {$socket_base_addr == 0x020200000000} {
      set socket_base_addr [expr {$socket_base_addr + 0x40000000}]
    }
  }
...
create_root_design "" $num_sockets
