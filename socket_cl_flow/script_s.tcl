...
add_files -fileset utils_1 -norecurse tcl_hooks/post_opt_s.tcl
...
set_property -name STEPS.OPT_DESIGN.TCL.POST -value [get_files -of_object [get_filesets utils_1] post_opt_s.tcl] -objects [get_runs impl_1]
