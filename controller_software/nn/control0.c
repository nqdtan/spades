...
//  for (int i = CONV3D_CORE_ID*CONV3D_OFM_CNT; i < CONV3D2_OFM_CHN; i+=CONV3D_NUM_CORES*CONV3D_OFM_CNT) {
//    // fetch ofm
//    LSU0_RAM_START_IDX = 16;
//    LSU0_RAM_ADDR_OFFSET = 0;
//    LSU0_RAM_BLOCK_FACTOR = CONV3D_OFM_CNT * CONV3D2_OFM_SIZE_CEIL / LSU_WIDTH_SCALE;
//    LSU0_RAM_CYCLIC_FACTOR = 1;
//    ext_mem_offset = EXT_MEM_OFFSET + ((CONV3D2_MEM_OFFSET + CONV3D2_IFM_LEN + CONV3D2_WT_LEN + i * CONV3D2_OFM_SIZE_CEIL) << LOG2_WORD_SIZE);
//    LSU0_M_OFFSET_LO = (ext_mem_offset & 0xFFFFFFFF);
//    LSU0_M_OFFSET_HI = (ext_mem_offset >> 32);
//    LSU0_SEG_STRIDE = 0;
//    LSU0_SEG_COUNT = 1;
//    LSU0_LEN = CONV3D_OFM_CNT * CONV3D2_OFM_SIZE_CEIL / WORD_SCALE;
//    LSU0_MODE = 1;
//
//    TQ_LSU0_START();
//    TQ_LSU0_DONE();
...
//    LSU1_RAM_START_IDX = 0;
//    LSU1_RAM_ADDR_OFFSET = 0;
//    LSU1_RAM_BLOCK_FACTOR = CONV3D2_WT_SIZE_CEIL / LSU_WIDTH_SCALE;
//    LSU1_RAM_CYCLIC_FACTOR = CONV3D_NUM_CONV2D;
//
//    ext_mem_offset = EXT_MEM_OFFSET + ((CONV3D2_MEM_OFFSET + CONV3D2_IFM_LEN + i * CONV3D2_IFM_CHN * CONV3D2_WT_SIZE_CEIL + 0 * CONV3D2_WT_SIZE_CEIL) << LOG2_WORD_SIZE);
//    LSU1_M_OFFSET_LO = (ext_mem_offset & 0xFFFFFFFF);
//    LSU1_M_OFFSET_HI = (ext_mem_offset >> 32);
//    LSU1_SEG_STRIDE = CONV3D2_IFM_CHN * CONV3D2_WT_SIZE_CEIL / WORD_SCALE;
//    LSU1_SEG_COUNT = CONV3D_OFM_CNT;
//    LSU1_LEN = CONV3D_NUM_CONV2D * CONV3D2_WT_SIZE_CEIL / WORD_SCALE;
//    LSU1_MODE = 1;
//
//    TQ_LSU1_START();
//
...
//    LSU0_SEG_STRIDE = 0;
//    LSU0_SEG_COUNT = 1;
//    LSU0_RAM_BLOCK_FACTOR = CONV3D2_IFM_SIZE_CEIL / LSU_WIDTH_SCALE;
//    LSU0_RAM_CYCLIC_FACTOR = CONV3D_NUM_CONV2D;
//
//    ext_mem_offset = EXT_MEM_OFFSET + ((CONV3D2_MEM_OFFSET + 0 * CONV3D2_IFM_SIZE_CEIL) << LOG2_WORD_SIZE);
//    LSU0_M_OFFSET_LO = (ext_mem_offset & 0xFFFFFFFF);
//    LSU0_M_OFFSET_HI = (ext_mem_offset >> 32);
//    LSU0_LEN = CONV3D_NUM_CONV2D * CONV3D2_IFM_SIZE_CEIL / WORD_SCALE;
//    LSU0_MODE = 1;
//
//    TQ_LSU0_START();
//
...
//    TQ_LSU1_DONE();
//    int pp = 0;
//    for (int j = 0; j < CONV3D2_IFM_CHN; j+=CONV3D_NUM_CONV2D) {
//      int len = (j < CONV3D2_IFM_CHN_SCALE * CONV3D_NUM_CONV2D) ? CONV3D_NUM_CONV2D : (CONV3D2_IFM_CHN - CONV3D2_IFM_CHN_SCALE * CONV3D_NUM_CONV2D);
//
//      if (j + CONV3D_NUM_CONV2D < CONV3D2_IFM_CHN) {
//      // fetch weight
//      LSU1_RAM_START_IDX = 0;
//      LSU1_RAM_ADDR_OFFSET = (pp == 0) ? (CONV3D_OFM_CNT * CONV3D2_WT_SIZE_CEIL / LSU_WIDTH_SCALE) : 0;
//      LSU1_RAM_BLOCK_FACTOR = CONV3D2_WT_SIZE_CEIL / LSU_WIDTH_SCALE;
//      LSU1_RAM_CYCLIC_FACTOR = CONV3D_NUM_CONV2D;
//
//      ext_mem_offset = EXT_MEM_OFFSET + ((CONV3D2_MEM_OFFSET + CONV3D2_IFM_LEN + i * CONV3D2_IFM_CHN * CONV3D2_WT_SIZE_CEIL + (j + CONV3D_NUM_CONV2D) * CONV3D2_WT_SIZE_CEIL) << LOG2_WORD_SIZE);
//      LSU1_M_OFFSET_LO = (ext_mem_offset & 0xFFFFFFFF);
//      LSU1_M_OFFSET_HI = (ext_mem_offset >> 32);
//      LSU1_SEG_STRIDE = CONV3D2_IFM_CHN * CONV3D2_WT_SIZE_CEIL / WORD_SCALE;
//      LSU1_SEG_COUNT = CONV3D_OFM_CNT;
...
//      // fetch ifm
//      LSU0_RAM_START_IDX = 8;
//      LSU0_RAM_ADDR_OFFSET = (pp == 0) ? CONV3D2_IFM_SIZE_CEIL / LSU_WIDTH_SCALE : 0;
//      LSU0_SEG_STRIDE = 0;
//      LSU0_SEG_COUNT = 1;
//      LSU0_RAM_BLOCK_FACTOR = CONV3D2_IFM_SIZE_CEIL / LSU_WIDTH_SCALE;
//      LSU0_RAM_CYCLIC_FACTOR = CONV3D_NUM_CONV2D;
//
//      ext_mem_offset = EXT_MEM_OFFSET + ((CONV3D2_MEM_OFFSET + (j + CONV3D_NUM_CONV2D) * CONV3D2_IFM_SIZE_CEIL) << LOG2_WORD_SIZE);
//      LSU0_M_OFFSET_LO = (ext_mem_offset & 0xFFFFFFFF);
//      LSU0_M_OFFSET_HI = (ext_mem_offset >> 32);
//      LSU0_LEN = CONV3D_NUM_CONV2D * CONV3D2_IFM_SIZE_CEIL / WORD_SCALE;
//      LSU0_MODE = 1;
...
//      }
//
//      KRN_IFM_OFFSET = (pp == 0) ? 0 : CONV3D2_IFM_SIZE_CEIL / LSU_WIDTH_SCALE;
//      for (int k = 0; k < CONV3D_OFM_CNT; k++) {
//        KRN_WT_OFFSET = ((pp == 0) ? 0 : (CONV3D_OFM_CNT * CONV3D2_WT_SIZE_CEIL / LSU_WIDTH_SCALE)) + (k * CONV3D2_WT_SIZE_CEIL / LSU_WIDTH_SCALE);
//        KRN_OFM_OFFSET = k * CONV3D2_OFM_SIZE_CEIL / LSU_WIDTH_SCALE;
//        KRN_LEN = len;
//        KRN_STATE = 1;
//        KRN_START = 1;
//        TQ_CL_START();
...
////    // maxpool
////    for (int k = 0; k < CONV3D_OFM_CNT; k++) {
////      KRN_IFM_OFFSET = k * CONV3D2_OFM_SIZE_CEIL / LSU_WIDTH_SCALE;
////      KRN_OFM_OFFSET = k * CONV3D2_OFM_SIZE_CEIL / LSU_WIDTH_SCALE;
////      KRN_STATE = 2;
////      KRN_START = 1;
////      TQ_CL_START();
...
//    LSU0_RAM_BLOCK_FACTOR = CONV3D_OFM_CNT * CONV3D2_OFM_SIZE_CEIL / LSU_WIDTH_SCALE;
//    LSU0_RAM_CYCLIC_FACTOR = 1;
//    ext_mem_offset = EXT_MEM_OFFSET + ((CONV3D2_MEM_OFFSET + CONV3D2_WT_LEN + CONV3D2_IFM_LEN + i * CONV3D2_OFM_SIZE_CEIL) << LOG2_WORD_SIZE);
//    LSU0_M_OFFSET_LO = (ext_mem_offset & 0xFFFFFFFF);
//    LSU0_M_OFFSET_HI = (ext_mem_offset >> 32);
//    LSU0_SEG_STRIDE = 0;
//    LSU0_SEG_COUNT = 1;
