...
#define MMIO_REGSPACE_OFFSET ((1<<16)<<6)
...
#define SOCKET2_NOC_ADDR        (0x201c0000000)
#define SOCKET3_NOC_ADDR        (0x20200000000)
#define SOCKET4_NOC_ADDR        (0x20280000000)
#define SOCKET5_NOC_ADDR        (0x202c0000000)
#define SOCKET6_NOC_ADDR        (0x20300000000)
#define SOCKET7_NOC_ADDR        (0x20340000000)
#define SOCKET8_NOC_ADDR        (0x20380000000)
#else
#define SOCKET_MANAGER_NOC_ADDR (0x20204000000)
#define SOCKET0_NOC_ADDR        (0x20100000000)
#define SOCKET1_NOC_ADDR        (0x20140000000)
#define SOCKET2_NOC_ADDR        (0x20180000000)
#define SOCKET3_NOC_ADDR        (0x201c0000000)
#define SOCKET4_NOC_ADDR        (0x20240000000)
#define SOCKET5_NOC_ADDR        (0x20280000000)
#define SOCKET6_NOC_ADDR        (0x202c0000000)
#define SOCKET7_NOC_ADDR        (0x20300000000)
#define SOCKET8_NOC_ADDR        (0x20340000000)
#endif

#define EXT_MEM_OFFSET 0xc100000000
